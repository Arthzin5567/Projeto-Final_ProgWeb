...
// Defina o componente CadastroCliente.
function CadastroCliente() {
  ...
  const handleClickButton = () => {
    // Faça uma solicitação POST para a URL especificada com os dados do Cliente.
...
// Exporte o componente CadastroCliente para uso em outros lugares.
